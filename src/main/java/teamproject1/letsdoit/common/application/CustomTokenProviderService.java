...
import teamproject1.letsdoit.common.config.OAuth2Config;
...
public class CustomTokenProviderService {
    ...
    public TokenMapping refreshToken(Authentication authentication, String refreshToken) {
        ...
        Date accessTokenExpriesIn = new Date(now.getTime() + oAuth2Config.getAuth().getAccessTokenExpiration());
    ...
    public TokenMapping createToken(Authentication authentication) {
        ...
        Date accessTokenExpiresIn = new Date(now.getTime() + oAuth2Config.getAuth().getAccessTokenExpiration());
        Date refreshTokenExpiresIn = new Date(now.getTime() + oAuth2Config.getAuth().getRefreshTokenExpiration());
